CREATE TABLE EMP_CIDADE (
    CIDADE_ID     NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE EMP_HABILIDADE (
    HABILIDADE_ID        NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE EMP_VAGA (
    VAGA_ID         NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE EMP_AVALIACAO (
    AVALIACAO_ID        NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
